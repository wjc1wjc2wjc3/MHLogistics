...
@interface TaskViewController ()<UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, HomeDelegate>

@property (nonatomic, weak) SliderHeaderView *shView;
@property (nonatomic, weak) UIScrollView *scrollView;
@property (nonatomic, strong) NSArray *titleArray;
@property (nonatomic, strong) NSArray *cellBtnTitleArray;
...
- (void)viewDidLoad {
    ...
    _cellBtnTitleArray = @[LOCALIZEDSTRING(@"setReminder"),LOCALIZEDSTRING(@"assignOrder")];
    _curPageIdx = 0;
...
- (SliderHeaderView *)shView {
    ...
    _titleArray = @[LOCALIZEDSTRING(@"excuting"), LOCALIZEDSTRING(@"excuted")];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setIgnoreBtnTitle:_cellBtnTitleArray[0]];
    [cell setGrapOrderBtnTitle:_cellBtnTitleArray[1]];
...
- (void)ignoreOP:(NSIndexPath*)idxP {
    IssuanceView *sv = [[IssuanceView alloc] initIssuanceView:UIDatePickerModeDate startDate:YES];
    sv.block = ^(NSDate *date, NSInteger tag) {
...
- (void)grapOrderOP:(NSIndexPath *)idxP {
    AssignOrderViewController *assignVC = [[AssignOrderViewController alloc] init];
    assignVC.hidesBottomBarWhenPushed = YES;
    assignVC.hd = _dataArray[idxP.row];
