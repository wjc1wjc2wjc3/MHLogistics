...
@interface MHPopMenuView ()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate>
...
+ (void)popWithDataArray:(NSArray *)dataArray
        ...
        triangleLocation:(CGPoint)point
                  action:(MHPopMenuBlock)action {
    MHPopMenuView *pop = [[MHPopMenuView alloc] initWithItems:dataArray width:width triangleLocation:point action:action];
    [pop show];
}
