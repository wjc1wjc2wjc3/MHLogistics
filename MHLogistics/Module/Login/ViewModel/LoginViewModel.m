...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    LoginViewModel *viewModel = [LoginViewModel mj_objectWithKeyValues:dictionary];
    return viewModel;
}

- (NSURLSessionDataTask *)startRequest:(NSDictionary *)param {
    
    return [APIManager SafePOST:[self formatUrl:kLogin] parameters:param success:^(NSURLSessionDataTask * _Nullable task, id  _Nullable responseObject) {
        
        
        LoginViewModel *vm = [[LoginViewModel alloc] initWithDictionary:responseObject];
